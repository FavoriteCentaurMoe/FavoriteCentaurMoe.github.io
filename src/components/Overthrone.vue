        ...
        <div class="my-auto">
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto small-center">
                ...
                <ul>
                    <li>I worked on movement and combat. Specifically, I worked a lot on "Ghost Mode". When a player dies they spawn on the side of the map as a ghost and can throw bombs into the map to break up bits of it.</li>
