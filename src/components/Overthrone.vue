          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-2">
            <div class="resume-content mr-auto">
                ...
                <div class="mb-4 col-md-8" >
                  ...
                  <p><b>My role</b>: Gameplay Programmer/Designer. I primarily worked on player movement, weapons, and audio. The role of Designer was shared between all team members. I helped conduct playtesting sessions, gather feedback, and balance the game </p>
                  ...
                  <p>Check in a while for some updates! </p>
                </div>    
              </div>
          </div>
        </div>
